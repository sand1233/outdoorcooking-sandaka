...
namespace ElegantBoutique.Controllers
{
    ...
    [EnableCors("ElegantBoutique_AllowSpecificOrigins")]
    [ApiController]
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> AuthenticateAdmin([FromBody] User formParams)
        {
            var user = await Context.Users.SingleOrDefaultAsync(x => x.Username == formParams.Username);
            if (user == null)
                return BadRequest(new { message = "Log in failed" });
     ...
     //   [Authorize(Roles = "admin")]
        ...
        private void SendConfirmationEmail(User user)
        {
            ...
            {
                From = new MailAddress("sachbagya@gmail.com"),
        ...
        private void SendPasswordResetEmail(User user)
        {
            ...
            var message = new MailMessage()
            {
                From = new MailAddress("elegantboutique26@gmail.com"),
                Subject = "Email reset",
